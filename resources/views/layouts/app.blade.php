...
<div class="wrapper d-flex flex-column min-vh-100 bg-light">
    ...
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            <div style="padding-top: 20px; max-width: 95% !important;" class="container">
                ...
                @if($errors->count() > 0)
                    <div class="alert alert-danger">
                        <span class="h3"><strong><i class="fas fa-exclamation-triangle" ></i> Attenzione!</strong> si sono verificati degli errori</span>
                        <hr>
